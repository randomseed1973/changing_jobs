def c19_w_recovered():
    ...
    c19w_df = pd.read_csv('./Original_Data/'+ "time_series_covid19_recovered_global.csv" , encoding = "utf=8")
    ...
    for St in cc188:
        ...
        St_day.columns = Cn
        # print(St_ed_df.head())
        St_day.to_csv("./csv/csv_day_Recovered/" + St + "_day.csv", encoding="utf-8", index=None)
        #print(St_day)
        St_d.clear()
        St_ED.clear()
    ...
    #csvファイルへの書き込み
    c19w_Recovered.to_csv("./csv/csv_comp/" + "c19w_Recovered.csv",index =None , encoding = "utf=8")

    #csvファイルからの読み込み
    c19w_Recovered = pd.read_csv("./csv/csv_comp/" + "c19w_Recovered.csv" , encoding = "utf=8")
